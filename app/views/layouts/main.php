      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
              ...
              <ul class="navbar-nav">
                  ...
                  <?php elseif (isset($_SESSION['is_trabajador']) && $_SESSION['is_trabajador'] === true): ?>
                      <!-- Trabajador autenticado -->
                      <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                              <i class="fas fa-user-tie me-2"></i><?= $_SESSION['trabajador_nombre'] ?>
                          </a>
                          <ul class="dropdown-menu dropdown-menu-end">
                              <?php if ($_SESSION['trabajador_rol'] === 'admin'): ?>
                                  <li><a class="dropdown-item" href="<?= Helper::url('admin') ?>">Panel de Administración</a></li>
                              <?php else: ?>
                                  <li><a class="dropdown-item" href="<?= Helper::url('trabajador/dashboard') ?>">Mi Dashboard</a></li>
                                  <li><a class="dropdown-item" href="<?= Helper::url('trabajador/reservas') ?>">Mis Reservas</a></li>
                              <?php endif; ?>
                              <li><hr class="dropdown-divider"></li>
